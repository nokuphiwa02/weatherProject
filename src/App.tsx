...
export const App = () => {
  ...
  useEffect(() => {
    ...
    const url = `https://api.open-meteo.com/v1/forecast?latitude=${latitude}&longitude=${longitude}&current=temperature_2m,relative_humidity_2m,wind_speed_10m,weather_code&hourly=temperature_2m,weather_code&daily=temperature_2m_mean,weather_code&timezone=auto`;
  ...
  return (
    <div data-theme={isDark ? "dark" : "light"}>
      ...
      {error && (
        <div style={{ color: "black", textAlign: "center", padding: "10px" }}>
          {error}
        </div>
      )}
    </div>
