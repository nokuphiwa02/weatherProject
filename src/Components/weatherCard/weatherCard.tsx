...
const WeatherCard: React.FC<WeatherProps> = ({ weather, units }) => {
if (!weather) return null;

const rawtemparature =
units === "°C" ? weather.temperature : weather.temperature * 1.8 + 32;
const temparature = Math.round(rawtemparature);
